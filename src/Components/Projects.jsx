          ...
          <div className="seeMore-wrapper">
            <div className="news-card">
              ...
              <div className="news-card__text-wrapper">
                ...
                <div className="news-card__details-wrapper">
                  <p className="news-card__excerpt">
                    Originally this was meant to be a Countdown to christmas but
                    by the time It was almost new year so I switched it out so
                    it would be a yearly Countdown instead of just to
                    christmas.&hellip;
                  </p>
                  <a
                    href="https://thedarkgalaxy.netlify.app"
