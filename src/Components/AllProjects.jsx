          ...
          <div className="seeMore-wrapper">
            <div className="news-card">
              ...
              <div className="news-card__text-wrapper">
                ...
                <div className="news-card__details-wrapper">
                  <p className="news-card__excerpt">
                    Experience my motivational project, crafted while exploring
                    CSS animations and keyframes. This captivating creation aims
                    to bring a smile to every visitor's face. With the sole
                    purpose of spreading joy and positivity, the project
                    features interactive elements and charming animations that
                    are sure to brighten your day.&hellip;
                  </p>
                  <a
                    href="https://youareawesome.netlify.app/#"
                    className="news-card__read-more"
              ...
              <div className="news-card__text-wrapper">
                ...
                <div className="news-card__details-wrapper">
                  <p className="news-card__excerpt">
                    ...
                    journey. Indulge in the fusion of artistry and interactivity
                    as you delve into this unique and captivating
                    project.&hellip;
                  </p>
                  <a
                    href="https://parallax-berserk.netlify.app/"
